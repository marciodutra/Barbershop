...
<head>
  ...
  <title>Atualização sobre nós</title>
...
<header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="search-bar">
      <form class="search-form d-flex align-items-center" method="POST" action="#">
        <input type="text" name="query" placeholder="Pesquise" title="Enter search keyword">
        ...
        <ul id="service-nav" class="nav-content collapse " data-bs-parent="#service-nav">
          ...
          <li>
            <a  href="manage-service.php">
              <i class="bi bi-circle active"></i><span>Gerenciar serviços</span>
            </a>
          </li>
        </ul>
      </li>
        ...
        <ul id="pages-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a class="nav-link" href="about-us.php">
              <i class="bi bi-circle active"></i><span>Sobre nós</span>
            </a>
          </li>
          <li>
            <a href="location.php">
    ...
    <section class="section">
      <div class="row">
        ...
        <?php if (isset($_GET['info'])) { ?>
                ...
                ?>
                 <div class="form-group"> <label for="exampleInputEmail1">Título da página</label> <input type="text" class="form-control mt-1" name="pagetitle" id="pagetitle" value="<?php  echo $row['PageTitle'];?>" required="true"> </div> 
                 <div class="form-group mt-2"> <label for="exampleInputPassword1">Descrição da página</label> <textarea name="pagedes" id="pagedes" rows="5" class="form-control mt-2">
