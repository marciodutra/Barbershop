    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="pages-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="about-us.php">
              <i class="bi bi-circle"></i><span>Sobrer nós</span>
            </a>
          </li>
          <li>
            <a href="location.php">
    ...
    <section class="section">
      <div class="row">
        ...
        <form method="post">
              ...
              ?> 
                             <div class="form-group"> <label for="exampleInputEmail1">Nome do serviço</label> <input type="text" class="form-control mt-1" id="sername" name="sername" placeholder="Service Name" value="<?php  echo $row['ServiceName'];?>" required="true"> </div>
                             <div class="form-group mt-2"> <label for="exampleInputEmail1">Descrição do serviço</label> <textarea type="text" class="form-control mt-1" id="sername" name="serdesc" placeholder="Service Name" value="" required="true"><?php  echo $row['ServiceDescription'];?></textarea> </div>
                             <div class="form-group mt-2"> <label for="exampleInputPassword1">Custo</label> <input type="text" id="cost" name="cost" class="form-control mt-1" placeholder="Cost" value="<?php  echo $row['Cost'];?>" required="true"> </div>
                             <div class="form-group"> <label for="exampleInputPassword1">Imagem</label>  <img src="assets/img/<?php echo $row['Image']?>" width="120" class="mt-3">
                             ...
                             <a>Atualizar imagem</a> 
                            </div>
                             <?php } ?>
                              <button type="submit" name="submit" class="btn btn-primary mt-2">Atualizar</button>
                             <a href="manage-service.php"  class="btn btn-danger mt-2">Voltar</a>
                             </form> 
        </div>
      </div>
    </section>
