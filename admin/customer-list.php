    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Atendimento ao Cliente</li>
        </ol>
      </nav>
    </div>
    <!-- End Page Title -->
        ...
        <div class="table-responsive bs-example widget-shadow">
                        ...
                        <thead>
                            ...
                            <td><?php  echo $row['nama'];?></td>
						 	...
						 	<td> <a href="add-customer.php?addid=<?php echo $row['id'];?>" class="btn btn-primary">Atribuir serviços</a>
                            <a href="customer-list.php?delid=<?php echo $row['id'];?>" class="btn btn-danger" onClick="return confirm('Tem certeza de que deseja excluir?')">Delete</a>
						 		</td>
                                 </tr>  
                                  <?php 
                                $cnt=$cnt+1;
