        ...
        <ul id="service-nav" class="nav-content collapse " data-bs-parent="#service-nav">
          ...
          <li>
            <a class="nav-link collapsed" href="manage-service.php">
              <i class="bi bi-circle"></i><span>Gerenciar serviço</span>
            </a>
          </li>
        </ul>
      </li>
    ...
    <section class="section">
      <div class="row">
        ...
        <?php if (isset($_GET['info'])) { ?>
                    ...
                    <?php } ?>
							 <div class="form-group"> <label for="exampleInputEmail1">Nome do serviço</label> <input type="text" class="form-control mt-1" id="sername" name="sername" placeholder="Service Name" value="" required="true"> </div>
							 <div class="form-group mt-2"> <label for="exampleInputEmail1">Descrição do serviço</label> <textarea type="text" class="form-control mt-1" id="sername" name="serdesc" placeholder="Service Name" value="" required="true"></textarea> </div>
							  <div class="form-group mt-2"> <label for="exampleInputPassword1">Custo</label> <input type="text" id="cost" name="cost" class="form-control mt-1" placeholder="Cost" value="" required="true"> </div>
							<div class="form-group mt-2"> <label for="exampleInputEmail1">Imagens</label> <input type="file" class="form-control mt-1" id="image" name="image" value="" required="true"> </div>
							  <button type="submit" name="submit" class="btn btn-primary mt-2">Adicionar</button>
                    </form> 
        </div>
      </div>
    </section>
